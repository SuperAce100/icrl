---
title: "Installation"
description: "Install ICICL and configure your environment for self-improving LLM agents"
---
...
ICICL automatically installs these dependencies:
...
ICICL uses LiteLLM for LLM access, which supports [100+ providers](https://docs.litellm.ai/docs/providers). Set up your preferred provider:
