---
title: "Introduction to ICICL"
description: "Build self-improving LLM agents that learn from their own successful experiences using Self-Generated In-Context Learning"
---
...
<Frame>
  <img
    ...
    alt="ICICL architecture diagram showing Bootstrap, Retrieve, Generate, and Curate phases"
  />
  <img
...
ICICL implements the **Self-Generated In-Context Learning** (SGICL) algorithm, enabling your LLM agents to bootstrap their own performance by learning from successful task completions.

Instead of requiring you to craft examples manually, ICICL agents:
...
<CardGroup cols={2}>
  <Card title="Quickstart" icon="rocket" href="/quickstart">
    Get your first ICICL agent running in under 5 minutes
  </Card>
  <Card title="Core Concepts" icon="book" href="/core-concepts/sgicl-algorithm">
    Understand how the SGICL algorithm works
  </Card>
...
<AccordionGroup>
  ...
  <Accordion title="Semantic retrieval" icon="magnifying-glass">
    ICICL uses FAISS-backed vector similarity search with sentence transformers to find the most relevant examples for each situation. You configure how many examples to retrieve with the `k` parameter.
  </Accordion>
...
The SGICL algorithm follows four phases:
...
ICICL implements the algorithm described in:
