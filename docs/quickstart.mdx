---
title: "Quickstart"
description: "Build your first self-improving ICRL agent in under 5 minutes"
---

## Installation

Install ICRL using your preferred package manager:
...
ICRL uses LiteLLM under the hood, which supports 100+ LLM providers. Configure your preferred provider:
...
<CardGroup cols={2}>
  <Card title="Core Concepts" icon="book" href="/core-concepts/icrl-algorithm">
    Learn how the ICRL algorithm enables self-improvement
  </Card>
