---
title: "API Overview"
description: "Complete API reference for the ICRL library"
---

## Package structure

ICRL is organized into the following modules:
...
<CardGroup cols={2}>
  <Card title="Agent" icon="robot" href="/api-reference/agent">
    The main class for training and running ICRL agents
  </Card>
...
```python models.py
from icrl import Trajectory, Step, Message
