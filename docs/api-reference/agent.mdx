---
title: "Agent"
description: "Main Agent class for training and running ICRL agents"
---

## Overview

The `Agent` class is the main interface for ICRL. It handles training, inference, database management, and curation.
