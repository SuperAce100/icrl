...
description: "Learn how ICRL stores and retrieves trajectories using FAISS-backed semantic search"
---

## Overview

The **Trajectory Database** is the persistent memory of your ICRL agent. It stores successful trajectories on disk and uses FAISS for efficient semantic similarity search.

## Database structure

When you create an agent with `db_path="./trajectories"`, ICRL creates the following structure:
